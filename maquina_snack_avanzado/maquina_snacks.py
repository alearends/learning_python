from maquina_snack_avanzado import snack
from maquina_snack_avanzado.servicio_snacks import ServicioSnacks
...
class MaquinaSnacks:
    ...
    def agregar_snack(self):
        ...
        nuevo_snack = snack.Snack(nombre, precio)
...
# Ejecuta: python -m maquina_snack_avanzado.maquina_snacks
